...
public static void main(String[] args) {
        String[] docs = new String[]{"The game of life is a game of everlasting learning", "The unexamined life is not worth living","Never stop learning"};
        TTF tf_idf = new TTF(docs);
