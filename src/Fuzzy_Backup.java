...
public static void main(String[] args) {
        ...
        String[] docs = new String[]{"Sports skills nature", "Technology Education people","Technology devices infrastructure software"};
         ...
         Fuzzy_Backup fu=new Fuzzy_Backup();
        ...
        //Fuzzy_Backup tf_idf = new Fuzzy_Backup(docs);
}

    public void unknowndocument(String undoc) {
         //To change body of generated methods, choose Tools | Templates.
         System.out.println();
         Fuzzy_Backup fo=new Fuzzy_Backup();
        ...
        */
        for(i=0;i<g;i++)
            System.out.println("Unknown Word : "+newwordVector1[i]);
        ...
        for(i=0;i<wordVector.length;i++){
            if(Arrays.asList(newwordVector1).contains(wordVector[i])){
                ...
                udocmatrix[i]=(double)((udoc.get(wordVector[i])/max)*idfVector[i]);
